...
test_expect_success 'find commit count for foo' '
	grep "<th class=.left.>Commits</th><td colspan=.4.>5</td>" tmp
'
test_expect_success 'find stats tab for foo' 'grep "foo/stats" tmp'
...
test_expect_success 'find commit count for bar' '
	grep "<th class=.left.>Commits</th><td colspan=.4.>50</td>" tmp
'
test_expect_success 'find stats tab for bar' 'grep "bar/stats" tmp'
